# backend/calculators/ziwei/tests/test_geocoding_integration.py
"""
Integration tests for ZiweiCalculator Geocoding integration.
...
# =============================================================================
# Test: birth_place 解析流程 (Requirement 2.1)
# =============================================================================
...
class TestBirthPlaceResolution:
    ...
    async def test_birth_place_resolves_to_coordinates(
        ...
        # Verify result is valid ZiweiFactors
        assert isinstance(result, ZiweiFactors)
        assert result.five_element_type is not None
        assert result.palaces is not None
...
# =============================================================================
# Test: birth_location 优先级 (Requirement 2.2)
# =============================================================================
...
class TestBackwardCompatibility:
    ...
    def test_existing_birth_location_code_works(self):
        ...
        """
        # This is how existing code creates ZiweiInput
        input_data = ZiweiInput(
            birth_datetime=datetime(1990, 5, 15, 14, 30),
            birth_location=(116.4, 39.9),
            gender="male"

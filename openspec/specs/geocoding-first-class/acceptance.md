...
- `.venv/bin/python -c 'import json; json.load(open(\"openspec/specs/geocoding-first-class/contract/geocoding_first_class_contract.v1.json\")); print(\"OK\")'`（契约机器可读校验）
...
## 必须产物（最低集合）
- `openspec/specs/geocoding-first-class/spec.md`
- `openspec/specs/geocoding-first-class/requirements.md`
- `openspec/specs/geocoding-first-class/tasks.md`

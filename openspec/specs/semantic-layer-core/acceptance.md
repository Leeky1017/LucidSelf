...
- `.venv/bin/python -c 'import json; json.load(open(\"openspec/specs/semantic-layer-core/contract/semantic_layer_core_contract.v1.json\")); print(\"OK\")'`（契约机器可读校验）
...
## 必须产物（最低集合）
- `openspec/specs/semantic-layer-core/spec.md`
- `openspec/specs/semantic-layer-core/requirements.md`
- `openspec/specs/semantic-layer-core/tasks.md`

...
Examples:
  scripts/agent_worktree_setup.sh 12 ls-github-bootstrap
  scripts/agent_worktree_setup.sh 12 ls-github-bootstrap --base origin/main
  scripts/agent_worktree_setup.sh 12 ls-github-bootstrap --no-sync
USAGE
}
